...
export default function CrudPage({
  ...
  return (
    <div className="space-y-6" dir="rtl">
      ...
      <div className="grid w-full grid-cols-1 gap-3 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm lg:grid-cols-[1fr_auto] lg:items-center">
        ...
        <div className="flex w-full items-center justify-end gap-2 lg:w-auto">
          ...
          <button
            type="button"
            onClick={openCreate}
            className="inline-flex h-11 items-center justify-center gap-2 rounded-xl bg-slate-900 px-5 text-sm font-semibold text-white shadow-sm transition-all duration-200 hover:bg-slate-800 hover:shadow-md active:scale-[0.98]"
          >
            <Plus size={17} />
            إضافة {title}
          </button>
...
>
          ...
          >
            <div className="flex items-start justify-between gap-4 border-b border-slate-200 p-5">
              <div>
                <h2 id="crud-modal-title" className="text-lg font-bold text-slate-900">
